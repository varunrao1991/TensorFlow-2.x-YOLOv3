...
def load_yolo_weights(model, weights_file):
    print("TRAIN_YOLO_TINY", TRAIN_YOLO_TINY)
    print("YOLO_TYPE", YOLO_TYPE)
...
def detect_image(Yolo, image_path, output_path, input_size=416, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45, rectangle_colors='', scale_int = 2):
    original_image      = cv2.imread(image_path) * scale_int
